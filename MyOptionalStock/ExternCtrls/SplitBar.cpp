...
namespace SOUI
{
    ...
    BOOL SSplitBar::OnSetCursor(const SOUI::CPoint &pt)
    {
    ...
    void SSplitBar::OnLButtonDown(UINT nFlags, SOUI::CPoint pt)
    {
    ...
    void SSplitBar::OnLButtonUp(UINT nFlags, SOUI::CPoint pt)
    {
    ...
    void SSplitBar::OnMouseMove(UINT nFlags, SOUI::CPoint pt)
    {
